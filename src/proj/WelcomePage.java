...
public class WelcomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnControl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/control.jpg"))); // NOI18N
        btnControl.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnControlActionPerformed(evt);
            }
        });
        getContentPane().add(btnControl, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 130, 40));

        btnPlay.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/play.jpg"))); // NOI18N
        btnPlay.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPlayActionPerformed(evt);
            }
        });
        getContentPane().add(btnPlay, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 300, 80, 40));
